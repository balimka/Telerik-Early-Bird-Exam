...
namespace Telerik_Early_Bird_Exam
{
    class Program
    {
        static void Main(string[] args)
        {       //https://pastebin.com/20d4n6Tm
            /*Socks Day Sale
            ...
            int standardPrice = int.Parse(Console.ReadLine());
            int discount = int.Parse(Console.ReadLine());
            int priceThreshold = int.Parse(Console.ReadLine());
            ...
            while (true)
            {
                ...
                int priceDiscount = standardPrice - (discount * counter);
                if (priceDiscount < priceThreshold)
                {
                    priceDiscount = priceThreshold;
                }
            ...
            Console.WriteLine($"{counter},{budget}");
